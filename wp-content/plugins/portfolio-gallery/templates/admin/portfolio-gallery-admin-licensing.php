...
?>
	...
	<div style="width:95%">
		<p><?php _e('After the purchasing the commercial version follow this steps:','portfolio-gallery'); ?></p>
		<ol>
			<li><?php _e('Deactivate Huge IT Portfolio / Gallery Plugin','portfolio-gallery'); ?></li>
			<li><?php _e('Delete Huge IT Portfolio / Gallery Plugin','portfolio-gallery'); ?></li>
